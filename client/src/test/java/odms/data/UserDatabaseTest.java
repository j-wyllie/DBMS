...
//        Assert.assertEquals("John Smith", userDb.getUser(0).getName());
//        Assert.assertEquals("Christchurch", userDb.getUser(0).getRegion());
//    }
//
//    @Test
...
//        Assert.assertEquals(clinician1, userDb.getUser("username"));
//    }
//
...
//        userDb.addUser(clinician1);
//        userDb.addUser(clinician2);
//        Assert.assertEquals(clinician2, userDb.getUser(1));
//    }
//
//    @Test(expected = UserNotFoundException.class)
