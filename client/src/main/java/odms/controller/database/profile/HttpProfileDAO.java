...
public class HttpProfileDAO implements ProfileDAO {
    ...
    private static final String RECEIVER_URL = "http://sengstudent@csse-s302g2:8080/api/v1/profiles/receivers";
    private static final String PROFILES_URL = "http://sengstudent@csse-s302g2:8080/api/v1/profiles";


    @Override
    public List<Profile> getAll() {
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/profiles/all";
    ...
    public void add(Profile profile) throws NHIConflictException, SQLException {
        ...
        Gson gson = new Gson();
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/setup/create";
        Map<String, Object> queryParams = new HashMap<>();
    ...
    public void removeByNhi(Profile profile) {
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/profiles/" + profile.getNhi();
        Request request = new Request(url, new HashMap<>());
        try {
            request.delete();
        } catch (IOException e) {
    ...
    public Integer size() {
        JsonParser parser = new JsonParser();
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/profiles/count";
        Map<String, Object> queryParams = new HashMap<>();
    ...
    public List<Profile> getDead() throws SQLException {
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/profiles/dead";
        Map<String, Object> queryParams = new HashMap<>();
        return getArrayRequest(url, queryParams);
    }
    ...
    public Boolean hasPassword(String nhi) {
        Response response = null;
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/setup/password";
    ...
    public Boolean checkCredentials(String username, String password) {
        JsonParser parser = new JsonParser();
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/login";
        Map<String, Object> queryParams = new HashMap<>();
        queryParams.put(USERNAME_STRING, username);
    ...
    public void updateBloodDonation(int profileId, int points) {
        String url = "http://sengstudent@csse-s302g2:8080/api/v1/profiles/" + profileId + "/blood-donation";
        Map<String, Object> queryParams = new HashMap<>();
